...
import { Sun, Zap, Thermometer, Settings, Play, X, MessageCircle, ArrowRight } from 'lucide-react';
import { Phone, Mail, MapPin } from 'lucide-react';
import { chatbox, chatboxOutline, closeOutline, logoFacebook, logoInstagram, logoLinkedin } from 'ionicons/icons';
...
const services = [
  { id: 1, title: 'Energía Solar', icon: <Sun size={30} />, color: '#E7F21C', desc: 'Paneles fotovoltaicos de alta gama.' },
  { id: 2, title: 'Climatización HVAC', icon: <Zap size={30} />, color: '#12B21E', desc: 'Sistemas Inverter de alta eficiencia.' },
  { id: 3, title: 'Calefacción Central', icon: <Thermometer size={30} />, color: '#12B21E', desc: 'Bombas de calor sustentables.' },
  { id: 4, title: 'Mantención Pro', icon: <Settings size={30} />, color: '#4A5568', desc: 'Mantenimiento técnico certificado.' }
];
        ...
        <IonHeader style={{backgroundColor: 'transparent'}} className={'header-scrolled'}>
          <IonToolbar className="toolbar-inner" style={{ '--background': 'transparent', padding: '0 20px' } as React.CSSProperties}>
            <div className="logo-wrapper" style={{backgroundColor: 'transparent'}}>
              <SVGAuGreenLogo />
              {/* <img src="/images/logo-augreen.svg" alt="AuGreen Logo" className="site-logo" /> */}
              {/* <div className="logo-content">
                <h2 className="logo-text"><span className="logo-text-au">Au</span><span className="logo-text-green">Green</span></h2>
            ...
            <IonButtons slot="end" className="header-actions">
              <div className="nav-link-group desktop-only">
                <IonButton fill="clear" className="nav-btn">Inicio</IonButton>
                <IonButton fill="clear" className="nav-btn">Servicios</IonButton>
        ...
        <IonContent  scrollEvents={true} onIonScroll={handleScroll}>
          ...
          <section className="section-padding" id="servicios">
            <IonGrid>
              <IonRow>
                {services.map(s => (
                  <IonCol key={s.id} className="service-col">
          ...
          <section className="about" id="nosotros">
            <div className="about-image">
              <img src="https://images.unsplash.com/photo-1621905251189-08b45d6a269e?auto=format&fit=crop&q=80&w=1000" alt="Técnicos Certificados AuGreen" />
          ...
          <section className="gallery" id="galeria">
            <div className="section-header">
              ...
              <h2 style={{ fontSize: 48 }}>TRABAJOS CERTIFICADOS</h2>
            </div>
          ...
          {chatOpen && (
            <motion.div className="chatbot-container" initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: 20 }}>
              <div className="chat-header">
                <div>Asistente AuGreen</div>
                <button className="chat-close" onClick={() => setChatOpen(false)}><X size={16} /></button>
              </div>
              <div className="chat-body">Hola, ¿en qué podemos ayudarte?</div>
              <div className="chat-input">
                <input placeholder="Escribe un mensaje..." />
                <button className="send-btn"><Play size={16} /></button>
              </div>
            </motion.div>
          )}
        </AnimatePresence>
